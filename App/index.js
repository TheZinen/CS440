...
// Importing the files from one js file to another
import Row from "./components/Row";
import Button from "./components/Button";
import calculator, { initialState } from "./util/calculator";

// Constant that sets our layout for the calculator
...
// Main function that calls all of our functions and allows for calculator to work properly
export default class App extends React.Component {
    state = initialState;

    // A function that initializes everytime a user taps on the screen
    handleTap = (type, value) => {
        this.setState(state => calculator(type, value, state));
    };

    // Everything below is taking in the value that is pressed, storing it in a specific location
    // then directing to the next action
    render() {
        return (
